...
HD_PWD='C:/Projects/pwm8/pwm8_proj/pwm8_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm8.tcl -notrace
